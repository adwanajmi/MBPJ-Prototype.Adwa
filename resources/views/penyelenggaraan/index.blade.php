    ...
    <div class="card-body bg-light">
      <div class="position-relative rounded-1 border bg-white dark__bg-1100 p-3">
        ...
        <div class="row gx-2">
          ...
          <div class="col-sm-6 mb-3">
            <label class="form-label" for="field-name">Tarikh Pembayaran</label>
            <input class="form-control form-control-sm" id="field-name" type="text" placeholder="">
          </div>
          <div class="col-sm-6 mb-3">
